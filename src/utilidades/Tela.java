...
public class Tela {
    ...
    //DESCRICAO PRODUTO
    public static Rectangle menuProdutosSelecionadosBounds() {
        return new Rectangle((int) (screenWidth * 0.4), (int) (screenHeight * 0.4), (int) (screenWidth * 0.6), (int) (screenHeight * 0.6));
    }
